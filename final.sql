...
CREATE TABLE Person (
    ...
    LastName VARCHAR(50),
    Email VARCHAR(100), -- ❌ removed UNIQUE
    PhoneNo VARCHAR(15),
    City VARCHAR(50)
);
...
CREATE TABLE Product (
    ...
    SellingPrice DECIMAL(10,2) CHECK (SellingPrice >= 0 AND SellingPrice >= CostPrice),
...
-- Users
INSERT INTO User (PersonID, ShopID, Username, Password, Role)
VALUES (1,1,'admin','admin','admin'), (2,2,'user','user','user');
...
-- Payments
INSERT INTO Payment (InvoiceID, ShopID, Amount, PaymentMode, Status)
VALUES
(1,1,45000,'Card','Completed'),
(2,2,500,'Cash','Completed');
